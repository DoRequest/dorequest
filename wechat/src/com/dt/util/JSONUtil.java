...
public final class JSONUtil {
   ...
   public static Object getStringFromJSONObject(final String json, final String key) {
       if(StringUtil.isEmpty(json)){
    	   throw new WeixinException("json is null");
       }
   ...
   public static <T> T toBean(String jsonStr, Class<T> beanClass) {
	   if(StringUtil.isEmpty(jsonStr)){
    	   throw new WeixinException("jsonStr is null");
       }
   ...
   public static <T> String toJson(T obj) {
       if(null==obj){
    	   throw new WeixinException("obj is null");
       }
   ...
   public static String toJson(Map<String, Object> map) {
       if(null==map){
    	   throw new WeixinException("map is null");
       }
   ...
   public static String prettyFormatJson(String jsonString) {
       if(StringUtil.isEmpty(jsonString)){
    	   throw new WeixinException("jsonString is null");
       }
